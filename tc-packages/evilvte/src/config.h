...
#define COLOR_STYLE 	XTERM /* Options: VTE_FIXED, LINUX, RXVT, TANGO, XTERM     */
...
#define PROGRAM_NAME           "evilvte for tinycore"
...
#define MENU_CUSTOM            "Add tab", "Remove tab", "Edit label", "New window", "Quit", "Separator", "Copy", "Paste", "Select all", "Separator", "Toggle background", "Toggle scrollbar", "Toggle status bar", "Toggle tabbar", "Toggle hotkeys locking", "Toggle always on top", "Separator", "Select font", "Submenu encoding list","Submenu input method"
...
#define    HOTKEY_TAB_PREVIOUS          CTRL GDK_Z
#define    HOTKEY_TAB_NEXT              CTRL GDK_A
...
#define LABEL_DEFAULT_ENCODING       "UTF-8"
